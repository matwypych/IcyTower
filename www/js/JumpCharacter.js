...
class JumpCharacter extends Character
{
    ...
    constructor(skeletonImage, centreX, centreY, updateStateMiliseconds)
    {
        ...
        this.WIDTH_OF_CHARACTER_ON_CANVAS = 90; /* the width and height that the skeleton will take up on the canvas */
        this.HEIGHT_OF_CHARACTER_ON_CANVAS = 90;

        this.centreX = centreX; /* set the start position of the skeleton in the maze */
        this.centreY = centreY;

        this.CHARACTER_SPEED = 10; /* set the skeleton's speed */
